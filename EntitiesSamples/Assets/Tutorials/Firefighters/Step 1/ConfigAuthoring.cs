...
namespace Tutorials.Firefighters {
    public class ConfigAuthoring : MonoBehaviour {
        [Header("Ponds")] public int NumPondsPerEdge;

        [Header("Bots")] public int NumTeams;
        public int NumPassersPerTeam;
        public int BotMoveSpeed = 3; // units per second
        public float LineMaxOffset = 4;

        [Header("Buckets")] public float BucketFillRate;
        ...
        [Header("Ground")] public int GroundNumColumns;
        public int GroundNumRows;

        [Header("Heat")] public Color MinHeatColor;
            ...
            public override void Bake(ConfigAuthoring authoring) {
                ...
                AddComponent(
                    ...
                    new Config {
                        ...
                        NumBuckets = math.max(authoring.NumBuckets, numTeams), // make sure there's at least one bucket per team
