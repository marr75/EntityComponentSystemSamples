...
namespace Tutorials.Kickball.Execute {
    public class ExecuteAuthoring : MonoBehaviour {
        [Header("Step 1")] public bool ObstacleSpawner;

        [Header("Step 2")] public bool PlayerSpawner;
        public bool PlayerMovement;

        [Header("Step 3")] public bool BallSpawner;
        public bool BallMovement;

        [Header("Step 4")] public bool NewPlayerMovement;
        public bool NewBallMovement;

        [Header("Step 5")] public bool BallCarry;
