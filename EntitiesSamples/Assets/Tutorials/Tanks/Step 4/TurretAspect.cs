...
namespace Tutorials.Tanks.Step4 {
    ...
    public readonly partial struct TurretAspect : IAspect {
        ...
        public Entity CannonBallSpawn { get => m_Turret.ValueRO.CannonBallSpawn; }
        public Entity CannonBallPrefab { get => m_Turret.ValueRO.CannonBallPrefab; }
        public float4 Color { get => m_BaseColor.ValueRO.Value; }
    }
}
