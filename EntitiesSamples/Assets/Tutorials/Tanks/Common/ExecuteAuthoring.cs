...
namespace Tutorials.Tanks.Execute {
    public class ExecuteAuthoring : MonoBehaviour {
        [Header("Step 2")] public bool TurretRotation;

        [Header("Step 3")] public bool TankMovement;

        [Header("Step 4")] public bool TurretShooting;

        [Header("Step 5")] public bool CannonBall;

        [Header("Step 6")] public bool TankSpawning;

        [Header("Step 7")] public bool SafeZone;

        [Header("Step 8")] public bool Camera;
