...
namespace Tutorials.Tanks.Step7 {
    [UpdateBefore(typeof(TurretShootingSystem)), UpdateInGroup(typeof(LateSimulationSystemGroup))]
    public partial struct SafeZoneSystem : ISystem {
        ...
        public void OnUpdate(ref SystemState state) {
            ...
            var safeZoneJob = new SafeZoneJob { SquaredRadius = radius * radius };
            safeZoneJob.ScheduleParallel();
        }
    }

    [WithAll(typeof(Turret)), WithOptions(EntityQueryOptions.IgnoreComponentEnabledState), BurstCompile]
