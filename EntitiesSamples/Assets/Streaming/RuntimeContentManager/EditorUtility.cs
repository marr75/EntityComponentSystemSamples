...
namespace Streaming.RuntimeContentManager {
    static class EditorUtility {
        ...
        public static bool CreateStuffValidation() => Selection.activeObject is DefaultAsset;
        ...
        public static void CreateStuff() {
            ...
            var prefab = PrefabUtility.SaveAsPrefabAssetAndConnect(go, folder + ".prefab", InteractionMode.AutomatedAction);
            ...
            for (var i = 0; i < objs.Length; i++) {
                ...
                if (mr.sharedMaterial.shader.name.Contains("Error")) { continue; }

                var ms = mf.sharedMesh.bounds.size;
                if (ms.x > 10 || ms.y > 10 || ms.z > 10) { continue; }
