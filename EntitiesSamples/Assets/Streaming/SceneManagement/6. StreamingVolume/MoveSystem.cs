...
namespace Streaming.SceneManagement.StreamingVolume {
    public partial struct MoveSystem : ISystem {
        [BurstCompile]
        public void OnCreate(ref SystemState state) { state.RequireForUpdate<Player>(); }
        ...
        public void OnUpdate(ref SystemState state) {
            ...
            foreach (var (transform, player) in SystemAPI.Query<RefRW<LocalTransform>, RefRO<Player>>().WithAll<Relevant>()) {
