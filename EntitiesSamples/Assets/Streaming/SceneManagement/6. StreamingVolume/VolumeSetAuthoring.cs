        ...
        public class Baker : Baker<VolumeSetAuthoring> {
            public override void Bake(VolumeSetAuthoring authoring) {
                ...
                if (subScene != null && authoring.volumes != null && authoring.volumes.Count > 0) {
                    ...
                    AddComponent(sceneEntity, new LevelInfo { sceneReference = new EntitySceneReference(subScene.SceneAsset) });

                    AddComponent(sceneEntity, new StreamingGO { InstanceID = authoring.gameObject.GetInstanceID() });
                    ...
                    foreach (var volume in authoring.volumes) {
                        ...
                        if (entity != Entity.Null) { buffer.Add(new VolumeBuffer { volumeEntity = entity }); }
                    }
                }
            }
        }
