        ...
        public void OnUpdate(ref SystemState state) {
            ...
            for (var index = 0; index < sectionLODs.Length; ++index) {
                ...
                state.EntityManager.AddComponentData(
                    sectionEntity,
                    new TileLODRange { LowerRadiusSq = lowerRadius * lowerRadius, HigherRadiusSq = higherRadius * higherRadius }
                );
            }
        }
    }
