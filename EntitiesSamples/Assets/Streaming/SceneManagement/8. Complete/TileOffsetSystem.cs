...
namespace Streaming.SceneManagement.CompleteSample {
    ...
    public partial struct TileOffsetSystem : ISystem {
        [BurstCompile]
        public void OnCreate(ref SystemState state) { state.RequireForUpdate<TileOffset>(); }
        ...
        public void OnUpdate(ref SystemState state) {
            ...
            foreach (var offset in offsets) {
                ...
                foreach (var transform in SystemAPI.Query<RefRW<LocalTransform>>().WithNone<Parent>()) {
                ...
                foreach (var transform in SystemAPI.Query<RefRW<LocalToWorld>>().WithNone<Parent, LocalTransform>()) {
