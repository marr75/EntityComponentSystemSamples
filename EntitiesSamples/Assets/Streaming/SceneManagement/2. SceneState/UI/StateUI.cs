...
namespace Streaming.SceneManagement.SceneState {
    ...
    public class StateUI : MonoBehaviour {
        ...
        static readonly Color LoadedMetaColor = new(0.6f, 1f, 0.6f);
        static readonly Color LoadedColor = new(0f, 1f, 0f);
        static readonly Color ErrorColor = new(1f, 0.5f, 0.5f);

        bool initialized;
        LoadingAction lastClickedAction = LoadingAction.None;
        int lastClickedRow;
        bool clicked = false;

        // Look up table to choose the color of the loading state based in its value
        static readonly Color[] ButtonColorPerState = {
        ...
        static readonly int[] AvailableLoadingActionsPerState = {
        ...
        void OnActionClick(int sceneIndex, LoadingAction action) {
