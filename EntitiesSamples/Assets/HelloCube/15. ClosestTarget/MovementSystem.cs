...
namespace HelloCube.ClosestTarget {
    public partial struct MovementSystem : ISystem {
        [BurstCompile]
        public void OnCreate(ref SystemState state) { state.RequireForUpdate<ExecuteClosestTarget>(); }

        [BurstCompile]
        public void OnUpdate(ref SystemState state) { new MovementJob { Delta = SystemAPI.Time.DeltaTime * 10 }.ScheduleParallel(); }
    }
