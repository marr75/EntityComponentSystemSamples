...
namespace Graphical.AnimationWithGameObjects {
    ...
    public partial struct SpawnSystem : ISystem {
        [BurstCompile]
        public void OnCreate(ref SystemState state) { state.RequireForUpdate<ExecuteAnimationWithGameObjects>(); }
        ...
        public void OnUpdate(ref SystemState state) {
            ...
            foreach (var entity in entities) {
                ...
                var instance = Object.Instantiate(warriorGOPrefab.Prefab);
