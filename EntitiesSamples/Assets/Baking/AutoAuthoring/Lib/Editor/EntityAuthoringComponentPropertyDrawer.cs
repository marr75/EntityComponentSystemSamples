        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            if (!targetComponent.IsBufferComponent) {
                ...
                if (authoringDataProperty == null) {
                    root.Add(
                        new HelpBox(
                            $"Authoring data type {targetComponent.GetComponentType().Name} is not serializable",
                ...
                if (typeof(ISharedComponentData).IsAssignableFrom(targetComponent.GetComponentType())
                    && referencesProperty.arraySize != 0) {
                    root.Add(
                        new HelpBox(
                            $"Shared Components do not support patching the entity references. "
